...
* Install Elastic Search:
  * Pull ElasticSearch `6.8.10` : `docker pull docker.elastic.co/elasticsearch/elasticsearch:6.8.10`
  * Running Elasticsearch from the command line:
  ```
  docker run -p 9200:9200 -e "http.host=0.0.0.0" -e "transport.host=127.0.0.1" -e "xpack.security.enabled=false" docker.elastic.co/elasticsearch/elasticsearch:6.8.10
  ```
...
* Install Elastic Search:
  ...
  * Running Elasticsearch from the command line:
  ```
  docker run -p 9200:9200 -e "http.host=0.0.0.0" -e "transport.host=127.0.0.1" docker.elastic.co/elasticsearch/elasticsearch:6.8.10
  ```
